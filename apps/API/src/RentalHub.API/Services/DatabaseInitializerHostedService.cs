...
public sealed class DatabaseInitializerHostedService : IHostedService
{
    ...
    private static async Task EnsureApplicationTablesAsync(RentalHubDbContext dbContext, CancellationToken cancellationToken)
    {
        await dbContext.Database.ExecuteSqlRawAsync(
            ...
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "PlanoNome" character varying(80);
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "StatusAssinatura" character varying(30) NOT NULL DEFAULT 'trial';
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "CicloCobranca" character varying(20) NOT NULL DEFAULT 'mensal';
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "ValorPlano" numeric(12,2);
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "DataInicioAssinatura" timestamp with time zone;
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "TrialExpiraEm" timestamp with time zone;
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "DiaVencimento" integer;
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "ProximoVencimentoEm" timestamp with time zone;
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "LimiteImoveis" integer;
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "LimiteUsuarios" integer;
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "ResponsavelFinanceiro" character varying(150);
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "EmailFinanceiro" character varying(180);
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "ObservacoesComerciais" character varying(1200);
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "UltimoPagamentoEm" timestamp with time zone;
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "UltimoPagamentoValor" numeric(12,2);
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "CanceladoEm" timestamp with time zone;
            ALTER TABLE "Tenants" ADD COLUMN IF NOT EXISTS "ComercialAtualizadoEm" timestamp with time zone;
            UPDATE "Tenants" SET "StatusAssinatura" = 'ativa' WHERE "IsRootTenant" = TRUE;
            ...
            CREATE TABLE IF NOT EXISTS "Proprietarios" (
                ...
                "ChavePix" character varying(180),
            ...
            ALTER TABLE "Proprietarios" ADD COLUMN IF NOT EXISTS "ChavePix" character varying(180);
            ...
            CREATE TABLE IF NOT EXISTS "SupportAccessSessions" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY,
                "TenantId" integer NOT NULL,
                "UsuarioId" integer NOT NULL,
                ...
                "DataCriacao" timestamp with time zone NOT NULL,
                CONSTRAINT "PK_SupportAccessSessions" PRIMARY KEY ("Id"),
                CONSTRAINT "FK_SupportAccessSessions_Tenants_TenantId" FOREIGN KEY ("TenantId") REFERENCES "Tenants" ("Id") ON DELETE RESTRICT,
                CONSTRAINT "FK_SupportAccessSessions_Usuarios_UsuarioId" FOREIGN KEY ("UsuarioId") REFERENCES "Usuarios" ("Id") ON DELETE RESTRICT
            );
            CREATE UNIQUE INDEX IF NOT EXISTS "IX_SupportAccessSessions_TokenHash" ON "SupportAccessSessions" ("TokenHash");
            CREATE INDEX IF NOT EXISTS "IX_SupportAccessSessions_TenantId_UsuarioId_ExpiraEm" ON "SupportAccessSessions" ("TenantId", "UsuarioId", "ExpiraEm");
            CREATE INDEX IF NOT EXISTS "IX_SupportAccessSessions_UsuarioId" ON "SupportAccessSessions" ("UsuarioId");
            ...
            CREATE TABLE IF NOT EXISTS "Imoveis" (
                ...
                "PercentualRepasseSocio" numeric(8,2),
                "Status" integer NOT NULL,
                "DataCriacao" timestamp with time zone NOT NULL,
                "DataAtualizacao" timestamp with time zone,
                CONSTRAINT "PK_Imoveis" PRIMARY KEY ("Id"),
                CONSTRAINT "FK_Imoveis_Proprietarios_ProprietarioId" FOREIGN KEY ("ProprietarioId") REFERENCES "Proprietarios" ("Id") ON DELETE SET NULL,
            ...
            ALTER TABLE "Imoveis" ALTER COLUMN "ProprietarioId" DROP NOT NULL;
            ALTER TABLE "Imoveis" ADD COLUMN IF NOT EXISTS "PercentualRepasseSocio" numeric(8,2);
            ALTER TABLE "Imoveis" ALTER COLUMN "PercentualRepasseSocio" DROP NOT NULL;
            ...
            CREATE TABLE IF NOT EXISTS "ReservaPreCheckins" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY,
                "TenantId" integer NOT NULL,
                ...
                "SubmetidoEm" timestamp with time zone,
                "AprovadoEm" timestamp with time zone,
                "AprovadoPorUsuarioId" integer,
                "ReprovadoEm" timestamp with time zone,
                "MotivoReprovacao" character varying(1000),
                "Observacoes" character varying(1000),
                "DataCriacao" timestamp with time zone NOT NULL,
                "DataAtualizacao" timestamp with time zone,
                CONSTRAINT "PK_ReservaPreCheckins" PRIMARY KEY ("Id"),
                CONSTRAINT "FK_ReservaPreCheckins_Reservas_ReservaId" FOREIGN KEY ("ReservaId") REFERENCES "Reservas" ("Id") ON DELETE CASCADE,
                CONSTRAINT "FK_ReservaPreCheckins_Tenants_TenantId" FOREIGN KEY ("TenantId") REFERENCES "Tenants" ("Id") ON DELETE RESTRICT,
                CONSTRAINT "FK_ReservaPreCheckins_Usuarios_AprovadoPorUsuarioId" FOREIGN KEY ("AprovadoPorUsuarioId") REFERENCES "Usuarios" ("Id") ON DELETE SET NULL
            );

            CREATE UNIQUE INDEX IF NOT EXISTS "IX_ReservaPreCheckins_TokenHash" ON "ReservaPreCheckins" ("TokenHash");
            CREATE INDEX IF NOT EXISTS "IX_ReservaPreCheckins_TenantId_ReservaId" ON "ReservaPreCheckins" ("TenantId", "ReservaId");
            CREATE INDEX IF NOT EXISTS "IX_ReservaPreCheckins_TenantId_Status_ExpiraEm" ON "ReservaPreCheckins" ("TenantId", "Status", "ExpiraEm");
            CREATE INDEX IF NOT EXISTS "IX_ReservaPreCheckins_ReservaId" ON "ReservaPreCheckins" ("ReservaId");
            CREATE INDEX IF NOT EXISTS "IX_ReservaPreCheckins_AprovadoPorUsuarioId" ON "ReservaPreCheckins" ("AprovadoPorUsuarioId");

            CREATE TABLE IF NOT EXISTS "ReservaHospedesCadastro" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY,
                "TenantId" integer NOT NULL,
                "ReservaPreCheckinId" integer NOT NULL,
                "Nome" character varying(180) NOT NULL,
                "Cpf" character varying(14) NOT NULL,
                "Telefone" character varying(40),
                "Email" character varying(180),
                "DataNascimento" timestamp with time zone,
                "MenorDeIdade" boolean NOT NULL,
                "FotoDocumentoUrl" character varying(800),
                "Status" integer NOT NULL,
                "ObservacoesAnalise" character varying(1000),
                "DataCriacao" timestamp with time zone NOT NULL,
                "DataAtualizacao" timestamp with time zone,
                CONSTRAINT "PK_ReservaHospedesCadastro" PRIMARY KEY ("Id"),
                CONSTRAINT "FK_ReservaHospedesCadastro_PreCheckins_ReservaPreCheckinId" FOREIGN KEY ("ReservaPreCheckinId") REFERENCES "ReservaPreCheckins" ("Id") ON DELETE CASCADE,
                CONSTRAINT "FK_ReservaHospedesCadastro_Tenants_TenantId" FOREIGN KEY ("TenantId") REFERENCES "Tenants" ("Id") ON DELETE RESTRICT
            );

            CREATE INDEX IF NOT EXISTS "IX_ReservaHospedesCadastro_TenantId_ReservaPreCheckinId" ON "ReservaHospedesCadastro" ("TenantId", "ReservaPreCheckinId");
            CREATE INDEX IF NOT EXISTS "IX_ReservaHospedesCadastro_TenantId_Cpf" ON "ReservaHospedesCadastro" ("TenantId", "Cpf");
            CREATE INDEX IF NOT EXISTS "IX_ReservaHospedesCadastro_ReservaPreCheckinId" ON "ReservaHospedesCadastro" ("ReservaPreCheckinId");

            CREATE TABLE IF NOT EXISTS "ReservaVeiculosCadastro" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY,
                "TenantId" integer NOT NULL,
                "ReservaPreCheckinId" integer NOT NULL,
                ...
                "DataCriacao" timestamp with time zone NOT NULL,
                "DataAtualizacao" timestamp with time zone,
                CONSTRAINT "PK_ReservaVeiculosCadastro" PRIMARY KEY ("Id"),
                CONSTRAINT "FK_ReservaVeiculosCadastro_PreCheckins_ReservaPreCheckinId" FOREIGN KEY ("ReservaPreCheckinId") REFERENCES "ReservaPreCheckins" ("Id") ON DELETE CASCADE,
                CONSTRAINT "FK_ReservaVeiculosCadastro_Tenants_TenantId" FOREIGN KEY ("TenantId") REFERENCES "Tenants" ("Id") ON DELETE RESTRICT
            );

            CREATE INDEX IF NOT EXISTS "IX_ReservaVeiculosCadastro_TenantId_ReservaPreCheckinId" ON "ReservaVeiculosCadastro" ("TenantId", "ReservaPreCheckinId");
            CREATE INDEX IF NOT EXISTS "IX_ReservaVeiculosCadastro_TenantId_Placa" ON "ReservaVeiculosCadastro" ("TenantId", "Placa");
            CREATE INDEX IF NOT EXISTS "IX_ReservaVeiculosCadastro_ReservaPreCheckinId" ON "ReservaVeiculosCadastro" ("ReservaPreCheckinId");
            ...
            CREATE TABLE IF NOT EXISTS "ConfiguracoesRelatorioMensal" (
                "Id" integer GENERATED BY DEFAULT AS IDENTITY,
                "TenantId" integer NOT NULL,
                "Nome" character varying(140) NOT NULL,
                ...
                "DataCriacao" timestamp with time zone NOT NULL,
                "DataAtualizacao" timestamp with time zone,
                CONSTRAINT "PK_ConfiguracoesRelatorioMensal" PRIMARY KEY ("Id"),
                CONSTRAINT "FK_ConfiguracoesRelatorioMensal_Tenants_TenantId" FOREIGN KEY ("TenantId") REFERENCES "Tenants" ("Id") ON DELETE RESTRICT
            );

            CREATE UNIQUE INDEX IF NOT EXISTS "IX_ConfiguracoesRelatorioMensal_TenantId_Nome" ON "ConfiguracoesRelatorioMensal" ("TenantId", "Nome");
            CREATE INDEX IF NOT EXISTS "IX_ConfiguracoesRelatorioMensal_TenantId_Ativo_Ordem" ON "ConfiguracoesRelatorioMensal" ("TenantId", "Ativo", "Ordem");
            ...
            CREATE TABLE IF NOT EXISTS "RepassesProprietarios" (
                ...
                "ComissaoAdministradora" numeric(12,2) NOT NULL,
                "PercentualSocio" numeric(8,2) NOT NULL DEFAULT 100,
            ...
            ALTER TABLE "RepassesProprietarios" ADD COLUMN IF NOT EXISTS "PercentualSocio" numeric(8,2) NOT NULL DEFAULT 100;
