...
function exportPdf(path, params = {}) {
  return api.get(path, { params, responseType: 'blob' });
}
...
export const relatoriosApi = {
  ...
  financeiroPdf: (params = {}) => exportPdf('/relatorios/financeiro.pdf', params),
  imoveis: (params = {}) => api.get('/relatorios/imoveis', { params }),
  imoveisCsv: (params = {}) => exportCsv('/relatorios/imoveis.csv', params),
  imoveisPdf: (params = {}) => exportPdf('/relatorios/imoveis.pdf', params),
  ...
  proprietariosPdf: (params = {}) => exportPdf('/relatorios/proprietarios.pdf', params),
